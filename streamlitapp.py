...
if uploaded_file is not None:
    ...
    st.image(image_data, caption='Uploaded Image', use_column_width=False, use_container_width=True)  # Updated for no warnings
...
st.write("""
---
### **Normal** or **Pneumonia**: This app helps diagnose pneumonia from chest X-rays.
""")
